...
/**
 * Carries the thinking/reasoning content returned by the model on a non-streaming response. Passed to the
 * {@link OnThinking @OnThinking}-annotated static handler declared on the AI service interface.
 */
